...
const useStyles = makeStyles()((theme) => ({
  ...
  filterPanel: {
    ...
    gap: theme.spacing(2),
    width: `calc(${theme.dimensions.drawerWidthTablet} + 80px)`, // افزایش عرض به میزان 30 پیکسل
  },
}));
...
const MainToolbar = ({
  ...
  filterMap,
  setFilterMap,
  setCloseAllAccordions,
  setExpandAllAccordions,
}) => {
  ...
  return (
    <Toolbar ref={toolbarRef} className={classes.toolbar}>
      ...
      <OutlinedInput
        ...
        fullWidth
      />
      <IconButton edge="end" onClick={handleToggleAccordions}>
        <Tooltip title={isExpanded ? t("sharedCloseAll") : t("sharedExpandAll")}>
          <ExpandMoreIcon />
        </Tooltip>
      </IconButton>
      <Popover
