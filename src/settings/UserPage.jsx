...
import { format, startOfDay, addWeeks, isValid } from 'date-fns-jalali';
...
const UserPage = () => {
  ...
  useEffect(() => {
    if (id === currentUser?.id?.toString()) {
      setItem({
        ...currentUser,
        expirationTime: currentUser.expirationTime ? new Date(currentUser.expirationTime) : addWeeks(startOfDay(new Date()), 1),
      });
    }
  }, [id, currentUser]);
