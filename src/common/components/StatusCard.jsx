...
const StatusCard = ({ deviceId, position, onClose, disableActions, desktopPadding = 0 }) => {
  ...
  const formatDate = (date) => {
    if (!date) return t('sharedUnknown');
    // تبدیل به شمسی و کم کردن یک روز برای جبران آفست
    return dayjs(date).tz('Asia/Tehran').calendar('jalali').subtract(1, 'day').format('YYYY/MM/DD HH:mm:ss');
  };
